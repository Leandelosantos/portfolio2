    ...
    <main ref={pageRef} id="main-content">
      ...
      <section
        style={{
          ...
          padding: 'clamp(100px, 14vh, 150px) clamp(24px, 6vw, 80px) clamp(60px, 8vh, 100px)',
      ...
      >
        ...
        <div>
          ...
          >
            Integro Claude Code, Gemini y técnicas de prompt engineering en cada proyecto.
            No como autocompletado: como capa de razonamiento que detecta errores,
            genera arquitectura y acelera decisiones sin bajar la calidad del código entregado.
          </p>
        </div>
      ...
      >
        ...
        <div className="ia-manifesto__left">
          ...
          >
            Escribir instrucciones precisas no es escribir más texto. Es definir contexto,
            restricciones y formato de salida con la misma disciplina que una especificación
            de software.
          </p>
          <p
            style={{
          ...
          >
            Uso Claude Code como par de trabajo permanente: revisión de arquitectura,
            generación de tests y detección de regresiones. El resultado es código que
            pasa review al primer intento.
          </p>
          <p
            style={{
              fontFamily: 'var(--font-ui)',
          ...
          >
            Cada entrega incluye análisis semántico de accesibilidad, revisión OWASP y
            validación de contratos de API. El cliente recibe un producto más seguro sin
            pagar el costo de auditorías manuales.
          </p>
        </div>
            ...
            {TERMINAL_LINES.map((line, i) => (
              <div
                ...
                style={{
                  fontFamily: 'var(--font-mono)',
                  fontSize: '12px',
                  color: line.startsWith('//') ? 'var(--color-text-secondary)' : 'var(--color-text-primary)',
                  lineHeight: 1.8,
                  whiteSpace: 'pre',
